  ...
  const handleSubmit = async () => {
    try {
      ...
      if (!response.ok) {
        ...
        // Special handling for database connection error (503 Service Unavailable)
        if (response.status === 503) {
          alert('Cannot connect to the database right now. Please check your internet connection and try again later.');
          return;
        }
