  ...
  try {
    ...
    if (!connection) {
      ...
      return NextResponse.json({ 
        ...
        details: 'Could not connect to the database. Please try again later or check your network connection.'
    ...
    if (!userData.image) {
      console.error('No image provided in user data');
      return NextResponse.json({ 
        success: false, 
    ...
    if (!imageUploadResult.success) {
      console.error('Failed to upload image to Cloudinary:', imageUploadResult.error);
      return NextResponse.json({ 
        success: false, 
